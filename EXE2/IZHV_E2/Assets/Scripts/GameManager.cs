...
public class GameManager : MonoBehaviour
{
    ...
    private bool higherThanHighScore = false;
    ...
    void Update()
    {
        ...
        if((int)mCurrentScore >= highScore && !higherThanHighScore)
        {
            higherThanHighScore = true;
            Player.instance.changeFace(1);
    ...
    public void SetupGame()
    {
        ...
        { // Setup already started game -> Retry.
            ...
            spawner.GetComponent<Spawner>().spawnObstacles = true;
    ...
    public void LooseGame()
    {
        ...
        // Loose the game.
        mGameLost = true;
        if((int)mCurrentScore > PlayerPrefs.GetInt("Highscore"))
        {
            PlayerPrefs.SetInt("Highscore", (int)mCurrentScore);
        }
    }
